        ...
        <div class="leaderboard-card">
          ...
          <div class="leaderboard-card__body">
            <div class="text-center">
              ...
              <img v-else src="https://dummyimage.com/50x50/cccccc/000000" class="circle-img mb-2" alt="User Img" />
            ...
            <tr v-for="index in 2" :key="index">
              <td>
                <div v-if="topClients[index + 2] && topClients[index + 2].client" class="d-flex align-items-center">
                  ...
                  <img v-else src="https://dummyimage.com/50x50/cccccc/000000" class="circle-img circle-img--small mr-2"
                    loading="lazy" />
