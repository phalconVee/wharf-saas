      ...
      <div class="col-lg-12 col-xl-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">
              {{ $t("sales.quotations.edit.form_title") }}
            </h3>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive table-custom w-95 m-auto">
                  <table class="table table-hover table-sm">
                    <thead>
                      <tr>
                        <th>{{ $t("common.s_no") }}</th>
                        <th class="text-center">{{ $t("common.code") }}</th>
                        ...
                        <th class="text-center">{{ $t("common.tax") }}</th>
                        <th class="text-center">{{ $t("common.subtotal") }}</th>
              ...
              <div class="row">
                <div v-if="taxes" class="form-group col-md-4">
                  <label for="orderTax">{{ $t("sales.common.quotation_tax") }}
                    <span class="required">*</span></label>
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("sales.quotations.edit.page_title") };
  },
  data: () => ({
    breadcrumbsCurrent: "sales.quotations.edit.breadcrumbs_current",
    breadcrumbs: [
      {
        name: "sales.quotations.edit.breadcrumbs_first",
        url: "home",
      },
      {
        name: "sales.quotations.edit.breadcrumbs_second",
        url: "quotations.index",
      },
      {
        name: "sales.quotations.edit.breadcrumbs_active",
        url: "",
      },
    ],
    form: new Form({
    ...
    async updateQuotation() {
      await this.form
        ...
        .then(({ data }) => {
          toast.fire({
            type: "success",
            title: this.$t("sales.quotations.edit.success_msg"),
          });
          this.$router.push({
