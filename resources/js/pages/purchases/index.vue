            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a v-if="$can('purchase-edit') ||
                  $can('purchase-view') ||
                  $can('purchase-delete')
                  " href="/purchases/pdf" v-tooltip="$t('common.export_pdf')" class="btn btn-secondary text-white">
                  <i class="fas fa-file-export"></i>
                </a>
                <a v-if="$can('purchase-edit') ||
                  $can('purchase-view') ||
                  $can('purchase-delete')
                  " @click="print" v-tooltip="$t('common.print_table')" class="btn btn-info text-white">
                  <i class="fas fa-print"></i>
                </a>
                <router-link v-if="$can('purchase-create')" :to="{ name: 'purchases.create' }" class="btn btn-primary text-white">
                  {{ $t("common.create") }}
                    ...
                    <td v-if="$can('purchase-edit') ||
                      ...
                      <div class="btn-group">
                        <a v-if="$can('purchase-view') && data.due > 0" v-tooltip="$t('common.add_payment')"
                          class="btn btn-secondary btn-sm text-white" @click="handleModal(data)">
