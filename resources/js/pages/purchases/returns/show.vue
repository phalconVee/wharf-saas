    ...
    <div class="row no-print mb-2">
      <div class="w-100 text-right float-right">
        <div class="btn-group" v-if="allData">
          <a @click="generatePDF()" href="#" class="btn btn-primary text-white">
            <i class="fas fa-download"></i> {{ $t("Download") }}
          </a>
          <a @click="printWindow()" href="#" class="btn btn-secondary text-white">
          ...
          <router-link :to="{ name: 'purchaseReturns.index' }" class="btn btn-dark text-white float-right">
