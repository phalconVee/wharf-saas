            ...
            >
                ...
                <div class="form-group row">
                    <label
                        for="currentPassword"
                        class="col-sm-2 col-form-label text-right"
                        >{{ $t('user_profile.current_password') }}</label
                    >
                    <div class="col-sm-10">
                        <input
                            type="password"
                ...
                <div class="form-group row">
                    <label
                        for="newPassword"
                        class="col-sm-2 col-form-label text-right"
                        >{{ $t('user_profile.new_password') }}</label
                    >
                    <div class="col-sm-10">
                        <input
                            type="password"
                            ...
                            id="newPassword"
                            :placeholder="
                                $t('user_profile.new_password_placeholder')
                            "
                        />
                ...
                <div class="form-group row">
                    <label
                        for="confirmPassword"
                        class="col-sm-2 col-form-label text-right"
                        >{{ $t('user_profile.confirm_password') }}</label
                    >
                    <div class="col-sm-10">
                        <input
                            type="password"
                            ...
                            id="confirmPassword"
                            :placeholder="
                                $t('user_profile.confirm_password_placeholder')
                            "
                        />
