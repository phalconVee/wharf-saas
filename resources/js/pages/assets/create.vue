      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">
              {{ $t('assets.list.create.form_title') }}
            </h3>
            ...
            <div class="card-body">
              ...
              <div v-if="form.depreciation == 1" class="row">
                <div class="form-group col-md-3">
                  <label for="depreciationType">{{ $t('assets.common.depreciation_type') }}
                    <span class="required">*</span></label>
                ...
                <div class="form-group col-md-3">
                  <label for="salvageValue">{{ $t('assets.common.salvage_value') }}
                    <span class="required">*</span></label>
                  <input id="salvageValue" v-model="form.salvageValue" type="number" class="form-control"
                    ...
                    :max="form.assetCost" :placeholder="$t('assets.common.salvage_value_placeholder')"
...
export default {
  ...
  metaInfo() {
    return { title: this.$t('assets.list.create.page_title') }
  },
  data: () => ({
    breadcrumbsCurrent: 'assets.list.create.breadcrumbs_current',
    breadcrumbs: [
      {
        name: 'assets.list.create.breadcrumbs_first',
        url: 'home',
      },
      {
        name: 'assets.list.create.breadcrumbs_second',
        url: 'assets.index',
      },
      {
        name: 'assets.list.create.breadcrumbs_active',
        url: '',
      },
    ],
    form: new Form({
    ...
    async saveAsset() {
      await this.form
        ...
        .then(() => {
          toast.fire({
            type: 'success',
            title: this.$t('assets.list.create.success_msg'),
          })
