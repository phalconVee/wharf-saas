        ...
        <div class="card">
          <div class="card-header setings-header">
            <div class="col-xl-4 col-4">
              <h3 class="card-title">
                {{ $t("setup.permissions.index.page_title") }}
              </h3>
            </div>
                ...
                <table class="table">
                  <thead>
                    <tr>
                      <th>{{ $t("common.s_no") }}</th>
                      <th>{{ $t("common.name") }}</th>
                      <th>{{ $t("setup.permissions.common.slug") }}</th>
                      <th>{{ $t("setup.permissions.common.guard_name") }}</th>
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("setup.permissions.index.page_title") };
  },
  data: () => ({
    breadcrumbsCurrent: "setup.permissions.index.breadcrumbs_current",
    breadcrumbs: [
      {
        name: "setup.permissions.index.breadcrumbs_first",
        url: "home",
      },
      {
        name: "setup.permissions.index.breadcrumbs_second",
        url: "setup.index",
      },
      {
        name: "setup.permissions.index.breadcrumbs_active",
        url: "",
      },
    ],
    query: "",
