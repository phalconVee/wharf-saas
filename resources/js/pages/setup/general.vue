                    ...
                    <div class="card">
                        <div class="card-header setings-header">
                            <h3 class="card-title">
                                {{
                                    $t(
                                        'setup.general_settings.index.page_title'
                                    )
                                }}
                            </h3>
                        </div>
                        <div class="card-body">
                            <div class="card inner-card">
                                <div class="card-header">
                                    {{
                                        $t(
                                            'setup.general_settings.index.company_info.info_title'
                                        )
                                    }}
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input
                                                ...
                                                :placeholder="
                                                    $t(
                                                        'common.company_name_placeholder'
                                                    )
                                                "
                                            />
                                            <has-error
                            ...
                            <div class="card inner-card">
                                <div class="card-header">
                                    {{
                                        $t(
                                            'setup.general_settings.index.code_prefixes.prefix_title'
                                        )
                                    }}
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label for="logo">{{
                                                $t(
                                                    'setup.general_settings.index.logo.white_logo'
                                                )
                                            }}</label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="blackLogo">{{
                                                $t(
                                                    'setup.general_settings.index.logo.black_logo'
                                                )
                                            }}</label>
                                            <div class="custom-file">
                                                <input
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label for="smallLogo">{{
                                                $t(
                                                    'setup.general_settings.index.logo.small_logo'
                                                )
                                            }}</label>
                                            <div class="custom-file">
                                                <input
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="favicon">{{
                                                $t(
                                                    'setup.general_settings.index.logo.favicon'
                                                )
                                            }}</label>
                                            <div class="custom-file">
                                                <input
