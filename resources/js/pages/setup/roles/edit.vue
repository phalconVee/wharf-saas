                    ...
                    <div class="card">
                        <div class="card-header setings-header">
                            <div class="col-xl-4 col-4">
                                <h3 class="card-title">
                                    {{
                                        $t(
                                            'setup.role_and_permission.edit.form_title'
                                        )
                                    }}
                                </h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="mb-3 mt-4">
                                {{
                                    $t(
                                        'setup.role_and_permission.edit.update_permission'
                                    )
                                }}
                            </h5>
...
export default {
    ...
    data: () => ({
        ...
        // Breadcrumbs
        breadcrumbsCurrent:
            'setup.role_and_permission.edit.breadcrumbs_current',
        breadcrumbs: [
            {
            ...
            await this.form
                ...
                .then(() => {
                    toast.fire({
                        type: 'success',
                        title: this.$t(
                            'setup.role_and_permission.edit.success_msg'
                        ),
                    });
