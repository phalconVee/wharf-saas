        ...
        <div class="card">
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group">
                <a href="/setup/payment-methods/pdf" v-tooltip="$t('common.export_table')" class="btn btn-secondary text-white">
                  <i class="fas fa-file-export"></i>
                </a>
                <a @click="print" v-tooltip="$t('common.print_table')" class="btn btn-info text-white">
                  <i class="fas fa-print"></i>
                </a>
                <router-link :to="{ name: 'paymentMethods.create' }" class="btn btn-primary text-white">
                  {{ $t("common.create") }}
