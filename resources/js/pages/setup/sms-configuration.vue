                    ...
                    <div class="card">
                        <div class="card-header setings-header">
                            <h3 class="card-title">
                                {{
                                    $t(
                                        'setup.sms_configuration.index.page_title'
                                    )
                                }}
                            </h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="twilio_account_sid"
                                        >{{
                                            $t(
                                                'setup.sms_configuration.form.twilio_account_sid'
                                            )
                                        }}
                                ...
                                <div class="form-group col-md-12">
                                    <label for="twilio_auth_token"
                                        >{{
                                            $t(
                                                'setup.sms_configuration.form.twilio_auth_token'
                                            )
                                        }}
                                        <span class="required">*</span></label
                                    >
                                ...
                                <div class="form-group col-md-12">
                                    <label for="twilio_from"
                                        >{{
                                            $t(
                                                'setup.sms_configuration.form.twilio_from'
                                            )
                                        }}
                                        <span class="required">*</span></label
                                    >
                                ...
                                <div class="form-group col-md-12">
                                    <label for="twilio_sms_service_sid"
                                        >{{
                                            $t(
                                                'setup.sms_configuration.form.twilio_sms_service_sid'
                                            )
                                        }}
                                        <span class="required">*</span></label
                                    >
