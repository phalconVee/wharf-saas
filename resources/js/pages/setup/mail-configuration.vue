                    ...
                    <div class="card">
                        <div class="card-header setings-header">
                            <h3 class="card-title">
                                {{
                                    $t(
                                        'setup.mail_configuration.index.page_title'
                                    )
                                }}
                            </h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="mail_mailer"
                                        >{{
                                            $t(
                                                'setup.mail_configuration.form.mail_mailer'
                                            )
                                        }}
                                ...
                                <div class="form-group col-md-12">
                                    <label for="mail_host"
                                        >{{
                                            $t(
                                                'setup.mail_configuration.form.mail_host'
                                            )
                                        }}
                                        <span class="required">*</span></label
                                    >
                                ...
                                <div class="form-group col-md-12">
                                    <label for="mail_port"
                                        >{{
                                            $t(
                                                'setup.mail_configuration.form.mail_port'
                                            )
                                        }}
                                        <span class="required">*</span></label
                                    >
                                ...
                                <div class="form-group col-md-12">
                                    <label for="mail_username"
                                        >{{
                                            $t(
                                                'setup.mail_configuration.form.mail_username'
                                            )
                                        }}
                                        <span class="required">*</span></label
                                    >
                                ...
                                <div class="form-group col-md-12">
                                    <label for="mail_password"
                                        >{{
                                            $t(
                                                'setup.mail_configuration.form.mail_password'
                                            )
                                        }}
                                        <span class="required">*</span></label
                                    >
                                ...
                                <div class="form-group col-md-12">
                                    <label for="mail_encryption"
                                        >{{
                                            $t(
                                                'setup.mail_configuration.form.mail_encryption'
                                            )
                                        }}
                                        <span class="required">*</span></label
                                    >
                                ...
                                <div class="form-group col-md-12">
                                    <label for="mail_from_address"
                                        >{{
                                            $t(
                                                'setup.mail_configuration.form.mail_from_address'
                                            )
                                        }}
                                        <span class="required">*</span></label
                                    >
                                ...
                                <div class="form-group col-md-12">
                                    <label for="mail_from_name"
                                        >{{
                                            $t(
                                                'setup.mail_configuration.form.mail_from_name'
                                            )
                                        }}
                                        <span class="required">*</span></label
                                    >
...
export default {
    ...
    data: () => ({
        ...
        breadcrumbsCurrent:
            'setup.mail_configuration.index.breadcrumbs_current',
        breadcrumbs: [
            {
    ...
    methods: {
        ...
        async getMailServerValues() {
            ...
            this.form.mail_mailer = data.mail_mailer;
            ...
            this.form.mail_encryption = data.mail_encryption;
            this.form.mail_from_address = data.mail_from_address;
            this.form.mail_from_name = data.mail_from_name;
        },
            ...
            await this.form
                ...
                .then(() => {
                    toast.fire({
                        type: 'success',
                        title: this.$t(
                            'setup.general_settings.index.success_message'
                        ),
                    });
                })
                .catch(() => {
