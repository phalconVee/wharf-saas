          ...
          <div class="card">
            <div class="card-header setings-header">
              <div class="col-xl-4 col-4">
                <h3 class="card-title">
                  {{ $t("setup.vat_rates.create.form_title") }}
                </h3>
              </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input id="rate" v-model="form.rate" type="number" class="form-control"
                  :class="{ 'is-invalid': form.errors.has('rate') }" name="rate" step="any"
...
export default {
  ...
  metaInfo() {
    return { title: this.$t("setup.vat_rates.create.page_title") };
  },
  data: () => ({
    breadcrumbsCurrent: "setup.vat_rates.create.breadcrumbs_current",
    breadcrumbs: [
      {
        name: "setup.vat_rates.create.breadcrumbs_first",
        url: "home",
      },
      {
        name: "setup.vat_rates.create.breadcrumbs_second",
        url: "setup.index",
      },
      {
        name: "setup.vat_rates.create.breadcrumbs_third",
        url: "vatRates.index",
      },
      {
        name: "setup.vat_rates.create.breadcrumbs_active",
        url: "",
      },
    ],
    form: new Form({
    ...
    async saveType() {
      await this.form
        ...
        .then(() => {
          toast.fire({
            type: "success",
            title: this.$t("setup.vat_rates.create.success_msg"),
          });
