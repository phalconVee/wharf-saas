                    ...
                    <div class="table-responsive table-custom">
                        <table class="table table-sm">
                            <thead>
                                <tr>
                                    <th>{{ $t("common.s_no") }}</th>
                                    <th>{{ $t("common.collect_by_name") }}</th>
                                    <th>{{ $t("common.invoice_no") }}</th>
                                    <th>{{ $t("common.client") }}</th>
                                    <th>{{ $t("common.invoice_amount") }}</th>
                                    <th>{{ $t("common.collected_amount") }}</th>
                                    <th>{{ $t("common.transection_date") }}</th>
                                </tr>
                            </thead>
                            <tbody>
...
export default {
    ...
    metaInfo() {
        return { title: this.$t("reports.collection_by_user_report") };
    },
    data: () => ({
        breadcrumbsCurrent: "reports.collection_by_user_report",
        breadcrumbs: [
            {
            ...
            {
                name: "reports.collection_by_user_report",
                url: "",
            },
        ],
        form: new Form({
