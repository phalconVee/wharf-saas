                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input
                                        ...
                                        :class="{
                                            'is-invalid':
                                                form.errors.has('newPassword'),
                                        }"
                                        id="newPassword"
                                        :placeholder="
                                            $t(
                                                'user_profile.new_password_placeholder'
                                            )
                                        "
                                    />
                                    <has-error
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input
                                        ...
                                        :placeholder="
                                            $t(
                                                'user_profile.confirm_password_placeholder'
                                            )
                                        "
                                    />
                                    <has-error
