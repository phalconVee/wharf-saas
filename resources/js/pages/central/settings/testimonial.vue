    ...
    <div>
        <div class="card">
            <div class="card-header setings-header">
                <h3 class="card-title">
                    {{ $t('common.testimonial_section_tagline') }}
                </h3>
            </div>
            <form
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            :placeholder="
                                $t(
                                    'common.testimonial_section_tagline_placeholder'
                                )
                            "
                        />
                        <has-error
                    ...
                    <div class="form-group">
                        <label for="testimonial_section_title">
                            {{ $t('common.testimonial_section_title') }}
                            <span class="required">*</span>
                        </label>
                        <input
                            type="text"
                            ...
                            :placeholder="
                                $t(
                                    'common.testimonial_section_title_placeholder'
                                )
                            "
                        />
                        <has-error
