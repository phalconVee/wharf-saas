    ...
    <div>
        ...
        <div class="card">
            <div class="card-header setings-header">
                <h3 class="card-title">{{ $t('common.all_features') }}</h3>
            </div>
            <form
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="all_features_section_tagline">
                            {{ $t('common.all_features_section_tagline') }}
                        ...
                        <input
                            ...
                            :placeholder="
                                $t(
                                    'common.all_features_section_tagline_placeholder'
                                )
                            "
                        />
                        <has-error
                    ...
                    <div class="form-group">
                        <label for="all_features_section_title">
                            {{ $t('common.all_features_section_title') }}
                            <span class="required">*</span>
                        </label>
                        <input
                            type="text"
                            ...
                            :placeholder="
                                $t(
                                    'common.all_features_section_title_placeholder'
                                )
                            "
                        />
                        <has-error
        ...
        <Modal v-if="showModal" @close="closeModal">
            <h5 slot="header">{{ $t('common.all_features') }}</h5>
