<template>
    <div>
        ...
        <div class="card">
            ...
            >
                <div class="card-header setings-header">
                    <h3 class="card-title">{{ $t('common.why_us') }}</h3>
                </div>
                <div class="card-body">
                    <!-- form group start -->
                    <div class="form-group">
                        <label for="why_us_tagline">
                            {{ $t('common.why_us_tagline') }}
                        ...
                        <input
                            ...
                            id="why_us_tagline"
                            :placeholder="
                                $t('common.why_us_tagline_placeholder')
                            "
                        />
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="why_us_title"
                            :placeholder="$t('common.why_us_title_placeholder')"
                        />
                        <has-error :form="form" field="why_us_title" />
                    </div>
                    <div class="form-group">
                        <label for="why_us_description">
                            {{ $t('common.why_us_description') }}
                            <span class="required">*</span>
                        </label>
                        <textarea
                            ...
                            :placeholder="
                                $t('common.why_us_description_placeholder')
                            "
                        ></textarea>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            {{
                                                $t(
                                                    'central.setting_images.description'
                                                )
                                            }}
                                        </th>
        ...
        <Modal v-if="showModal" @close="closeModal">
            <h5 slot="header">{{ $t('common.why_us') }}</h5>
                ...
                >
                    ...
                    <div class="form-group col-md-12">
                        <label for="description">
                            {{ $t('central.setting_images.description') }}
                            <span class="required">*</span>
                        </label>
                        <textarea
                            id="description"
                            ...
                            :placeholder="
                                $t(
                                    'central.setting_images.description_placeholder'
                                )
                            "
                        />
