    ...
    <div>
        ...
        <div class="card">
            <div class="card-header setings-header">
                <h3 class="card-title">{{ $t('common.features') }}</h3>
            </div>
            <form
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label for="features_section_tagline">
                            {{ $t('common.features_section_tagline') }}
                        ...
                        <input
                            ...
                            :placeholder="
                                $t(
                                    'common.features_section_tagline_placeholder'
                                )
                            "
                        />
                        <has-error
                    ...
                    <div class="form-group row">
                        ...
                        <input
                            ...
                            :placeholder="
                                $t('common.features_section_title_placeholder')
                            "
                        />
                        <has-error
                            :form="form"
                    ...
                    <div class="form-group row">
                        <label for="features_section_description">
                            {{ $t('common.features_section_description') }}
                        </label>
                        <textarea
                            ...
                            :placeholder="
                                $t(
                                    'common.features_section_description_placeholder'
                                )
                            "
                        >
                        </textarea>
        ...
        <Modal v-if="showModal" @close="closeModal">
            <h5 slot="header">{{ $t('common.features') }}</h5>
