                    ...
                    <div class="card">
                        <div class="card-header setings-header">
                            <div class="col-xl-4 col-4">
                                <h3 class="card-title">
                                    {{ $t("central.settings_sidebar_edit_currency") }}
                                </h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="rate" v-model="form.rate" type="text" class="form-control"
                                    ...
                                    :placeholder="$t('setup.currencies.common.central_currency_exchange_rate')" />
...
export default {
    ...
    metaInfo() {
        return { title: this.$t("central.settings_sidebar_edit_currency") };
    },
    components: {
        SettingsSidebar,
    },
    data: () => ({
        breadcrumbsCurrent: "central.settings_sidebar_edit_currency",
        breadcrumbs: [
            {
