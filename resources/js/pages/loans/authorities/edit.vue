      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">
              {{ $t('loans.authorities.edit.form_title') }}
            </h3>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input id="ccLoanLimit" v-model="form.ccLoanLimit" type="number" step=".01" class="form-control"
                    ...
                    :placeholder="$t('loans.common.cc_placeholder')" :min="form.ccLoanTaken" />
...
export default {
  ...
  metaInfo() {
    return { title: this.$t('loans.authorities.edit.page_title') }
  },
  data: () => ({
    breadcrumbsCurrent: 'loans.authorities.edit.breadcrumbs_current',
    breadcrumbs: [
      {
        name: 'loans.authorities.edit.breadcrumbs_first',
        url: 'home',
      },
      {
        name: 'loans.authorities.edit.breadcrumbs_second',
        url: 'authorities.index',
      },
      {
        name: 'loans.authorities.edit.breadcrumbs_active',
        url: '',
      },
    ],
    form: new Form({
    ...
    async updateAuthority() {
      await this.form
        ...
        .then(() => {
          toast.fire({
            type: 'success',
            title: this.$t('loans.authorities.edit.success_msg'),
          })
