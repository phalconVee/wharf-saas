      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">
              {{ $t('products.sub_categories.create.form_title') }}
            </h3>
...
export default {
  ...
  metaInfo() {
    return { title: this.$t('products.sub_categories.create.page_title') }
  },
  data: () => ({
    breadcrumbsCurrent: 'products.sub_categories.create.breadcrumbs_current',
    breadcrumbs: [
      {
        name: 'products.sub_categories.create.breadcrumbs_first',
        url: 'home',
      },
      {
        name: 'products.sub_categories.create.breadcrumbs_second',
        url: 'products.index',
      },
      {
        name: 'products.sub_categories.create.breadcrumbs_third',
        url: 'productSubCats.index',
      },
      {
        name: 'products.sub_categories.create.breadcrumbs_active',
        url: '',
      },
    ],
    form: new Form({
    ...
    async saveSubCategory() {
      await this.form
        ...
        .then(() => {
          toast.fire({
            type: 'success',
            title: this.$t('products.sub_categories.create.success_msg'),
          })
