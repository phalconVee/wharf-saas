      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">{{ $t('payroll.create.form_title') }}</h3>
...
export default {
  ...
  metaInfo() {
    return { title: this.$t('payroll.create.page_title') }
  },
  data: () => ({
    breadcrumbsCurrent: 'payroll.create.breadcrumbs_current',
    breadcrumbs: [
      {
        name: 'payroll.create.breadcrumbs_first',
        url: 'home',
      },
      {
        name: 'payroll.create.breadcrumbs_second',
        url: 'payroll.index',
      },
      {
        name: 'payroll.create.breadcrumbs_active',
        url: '',
      },
    ],
    form: new Form({
    ...
    async savePayroll() {
      await this.form
        ...
        .then(() => {
          toast.fire({
            type: 'success',
            title: this.$t('payroll.create.success_msg'),
          })
