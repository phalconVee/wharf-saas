          ...
          <div class="card-header setings-header">
            ...
            <div class="col-xl-8 col-8 float-right text-right">
              <div class="btn-group c-w-100">
                ...
                <a href="#" @click="uploadCsvModalShow()" v-tooltip="'Import'" class="btn btn-dark text-white">
                  <i class="fas fa-upload"></i>
                </a>
                <a :href="exportUrl" v-tooltip="$t('common.export_excel')" class="btn btn-info text-white">
                  <i class="fa fa-arrow-circle-down"></i>
                </a>
                <a href="/suppliers/pdf" v-tooltip="$t('common.export_pdf')" class="btn btn-secondary text-white">
                  <i class="fas fa-file-export"></i>
                </a>
                <a @click="print" v-tooltip="$t('common.print_table')" class="btn btn-info text-white">
                  <i class="fas fa-print"></i>
                </a>
                <router-link v-if="$can('supplier-create')" :to="{ name: 'suppliers.create' }" class="btn btn-primary text-white">
                  {{ $t("common.create") }}
