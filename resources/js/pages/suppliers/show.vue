          ...
          <div class="card-header p-2">
            <div class="row">
              ...
              <div class="col-md-2 text-right">
                <div class="btn-group">
                  <a @click="generatePDF()" href="#" class="btn btn-primary text-white" v-tooltip="$t('download')">
                    <i class="fas fa-download"></i>
                  </a>
                  <a @click="print()" href="#" class="btn btn-secondary text-white" v-tooltip="$t('print')">
                    <i class="fas fa-print"></i>
                  </a>
                  <a @click="refreshTable(activeTab)" href="#" v-tooltip="'Refresh'" class="btn btn-success text-white">
                            ...
                            <td v-if="$can('purchase-edit') ||
                              ...
                              <div class="btn-group">
                                ...
                                <a v-if="$can('purchase-delete')" v-tooltip="$t('common.delete')" href="#"
                                  class="btn btn-danger btn-sm text-white" @click="deletePurchaseData(data.slug)">
                            ...
                            <td v-if="$can('purchase-return-edit') ||
                              ...
                              <div class="btn-group">
                                ...
                                <a v-if="$can('purchase-return-delete')" v-tooltip="$t('common.delete')" href="#"
                                  class="btn btn-danger btn-sm text-white" @click="deletePurchaseReturnData(data.slug)">
                                  <i class="fas fa-trash" />
                                </a>
                              </div>
                            </td>
                            ...
                            <td v-if="$can('purchase-payment-edit') ||
                              ...
                              <div class="btn-group">
                                ...
                                <a v-if="$can('purchase-payment-delete')" v-tooltip="$t('common.delete')" href="#"
                                  class="btn btn-danger btn-sm text-white" @click="deletePaymentData(data.slug)">
                                  <i class="fas fa-trash" />
                                </a>
                              </div>
                            </td>
                            ...
                            <td v-if="$can('non-purchase-payment-view') ||
                              ...
                              <div class="btn-group">
                                ...
                                <a v-if="$can('non-purchase-payment-delete')" v-tooltip="$t('common.delete')" href="#"
                                  class="btn btn-danger btn-sm text-white" @click="deleteTransactionData(data.slug)">
                                  <i class="fas fa-trash" />
                                </a>
                              </div>
                            </td>
