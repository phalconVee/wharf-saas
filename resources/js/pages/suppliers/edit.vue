      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">{{ $t('suppliers.edit.form_title') }}</h3>
...
export default {
  ...
  metaInfo() {
    return { title: this.$t('suppliers.edit.page_title') }
  },
  data: () => ({
    breadcrumbsCurrent: 'suppliers.edit.breadcrumbs_current',
    breadcrumbs: [
      {
        name: 'suppliers.edit.breadcrumbs_first',
        url: 'home',
      },
      {
        name: 'suppliers.edit.breadcrumbs_second',
        url: 'suppliers.index',
      },
      {
        name: 'suppliers.edit.breadcrumbs_active',
        url: '',
      },
    ],
    form: new Form({
    ...
    async updateSupplier() {
      await this.form
        ...
        .then(() => {
          toast.fire({
            type: 'success',
            title: this.$t('suppliers.edit.success_msg'),
          })
