      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">
              {{ $t('expenses.sub_categories.edit.form_title') }}
            </h3>
...
export default {
  ...
  metaInfo() {
    return { title: this.$t('expenses.sub_categories.edit.page_title') }
  },
  data: () => ({
    breadcrumbsCurrent: 'expenses.sub_categories.edit.breadcrumbs_current',
    breadcrumbs: [
      {
        name: 'expenses.sub_categories.edit.breadcrumbs_first',
        url: 'home',
      },
      {
        name: 'expenses.sub_categories.edit.breadcrumbs_second',
        url: 'expenseSubCats.index',
      },
      {
        name: 'expenses.sub_categories.edit.breadcrumbs_active',
        url: '',
      },
    ],
    form: new Form({
    ...
    async updateSubCategory() {
      await this.form
        ...
        .then(() => {
          toast.fire({
            type: 'success',
            title: this.$t('expenses.sub_categories.edit.success_msg'),
          })
