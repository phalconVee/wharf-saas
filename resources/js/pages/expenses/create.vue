      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">
              {{ $t('expenses.list.create.form_title') }}
            </h3>
            ...
            <div class="card-body">
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="reason">{{ $t('expenses.list.common.expense_reason') }}
                ...
                <div v-if="items" class="form-group col-md-6">
                  <label for="subCategory">{{ $t('common.category_name') }}
                    <span class="required">*</span></label>
...
export default {
  ...
  metaInfo() {
    return { title: this.$t('expenses.list.create.page_title') }
  },
  data: () => ({
    breadcrumbsCurrent: 'expenses.list.create.breadcrumbs_current',
    breadcrumbs: [
      {
        name: 'expenses.list.create.breadcrumbs_first',
        url: 'home',
      },
      {
        name: 'expenses.list.create.breadcrumbs_second',
        url: 'expenses.index',
      },
      {
        name: 'expenses.list.create.breadcrumbs_active',
        url: '',
      },
    ],
    form: new Form({
    ...
    async saveExpense() {
      await this.form
        ...
        .then(() => {
          toast.fire({
            type: 'success',
            title: this.$t('expenses.list.create.success_msg'),
          })
