...
class CentralGeneralController extends Controller
{
    ...
    public function updateGeneralSettings(Request $request)
    {
        ...
        if ($request->logo) {
            ...
            $logoName = 'central-logo-' . time() . '.' . explode(
                '/',
        ...
        if ($request->blackLogo) {
            ...
            $blackLogoName = 'central-logo-black-' . time() . '.' . explode(
                '/',
        ...
        if ($request->smallLogo) {
            ...
            $smallLogoName = 'central-small-logo-' . time() . '.' . explode(
                '/',
        ...
        if ($request->favicon) {
            ...
            $favicon = 'central-favicon-' . time() . '.' . explode(
                '/',
