    ...
    public function collection()
    {
        ...
        $clientReceivableReports = ClientResource::collection($query->latest()->get())->map(function ($clientReceivableReport) {
            ...
            return [
                ...
                $currencySymbol . strval($clientReceivableReport->clientDue() ?: '0'),
                $currencySymbol . strval($clientReceivableReport->nonInvoiceCurrentDue() ?: '0'),
                $currencySymbol . strval($clientReceivableReport->clientDue() + $clientReceivableReport->nonInvoiceCurrentDue() ?: '0'),
            ];
        });
